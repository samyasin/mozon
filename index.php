                ...
                while($row = mysqli_fetch_assoc($query_result))
                {
                    ...
                    <div class="col-md-6 col-xl-3 p-b-30 m-lr-auto">
                        <div class="block1 wrap-pic-w">
                            <img src="admin/catimages/<?php echo $row['cat_image'] ?>" alt="No Image" width='200' height='200'>
                              
                            <a href="product.php?id=<?php echo $row['cat_id'] ?>" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
